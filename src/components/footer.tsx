        ...
        <footer className="bg-[oklch(0.45_0.05_60)] text-white border-t border-border">
            <div className="container mx-auto px-4 py-12">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-bold text-lg">
                                GNJR Innovación & Desarrollo
                            </span>
                        </div>
                        <p className="text-sm text-white/80 leading-relaxed">
                            Gremio Nacional de Juventudes Rurales de Chile.
                            Transformando el territorio desde la juventud rural.
                        </p>
                    </div>
                ...
                <div className="border-t border-white/20 mt-8 pt-8 text-center text-sm text-white/70">
                    <p>
                        © {new Date().getFullYear()} GNJR - Gremio Nacional de
                        Juventudes Rurales de Chile. Todos los derechos
                        reservados.
                    </p>
                </div>
            </div>
